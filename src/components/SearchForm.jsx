...
function SearchForm({value, setValue}) {
    ...
    return (
        ...
        <form className="search-form rounded-full flex rounded-full p-1 h-[35px] bg-gray-800 items-center" onSubmit={onSubmit}>
            <input value={search} onChange={e => setSearch(e.target.value.toLowerCase())} className="search-input p-1 rounded-full bg-transparent w-full px-4 focus:outline-none" type="text" placeholder="Search for movies..." />
