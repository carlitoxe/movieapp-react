...
function SearchForm({value, setValue}) {
  ...
  <div className="relative">
    ...
    <input
      ...
      className="block w-full px-8 py-1.5 pl-5 border rounded-full bg-transparent border-gray-600  placeholder-gray-500  text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
  ...
  className="absolute top-0 right-[0.5px] p-2.5 text-sm font-medium h-full text-white bg-blue-700 rounded-r-full border border-blue-700 hover:bg-blue-800 focus:ring-1 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
>
  <svg
    className="w-4 h-4"
    aria-hidden="true"
