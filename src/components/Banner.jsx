    ...
    return (
        <>  
                ...
                <section className="movieDetail-container mt-10">
                    <div 
                        className={`banner-background md:h-fit bg-cover bg-no-repeat`}
                        // style={{
                    ...
                    >
                        ...
                        <div className="backdrop-blur-lg pl-0 md:backdrop-blur-[2px] md:flex pt-6 pb-8 md:pb-44 md:pb-[3.2rem] pl-3" 
                            style={{
                        ...
                        >  
                            <div className="poster flex justify-center md:block md:ml-4">
                                {loading ? <div className='min-w-[150px] w-[150px] h-[200px] min-h-[200px] md:min-w-[250px] md:w-[250px] md:h-[375px] rounded-lg'><Skeleton width={250} height={375}/></div> : 
                                                     <img 
                                                     src={url ? url : noimage} 
